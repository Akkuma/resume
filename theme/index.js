...
Handlebars.registerHelper({
  or : (...args) => args.slice(0, -1).some(Boolean) ? args.at(-1).fn(this) : args.at(-1).inverse(this),
  isObject: (obj, options) => typeof obj === 'object' && !Array.isArray(obj) ? options.fn(this) : options.inverse(this),
  json: (data) => JSON.stringify(data),
  stripHttp: (url) =>  url.replace(/http(s?):\/\/(www\.)?/, ''),
